...
function Timer20() {
  ...
  useEffect(() => {
    document.title = "20-Minute Timer | Flow Sessions & Focused Work";
    return () => {
        ...
        <section className="max-w-4xl mx-auto px-8 mb-40">
          ...
          <div className="space-y-6">
            ...
            <p className="font-bold text-lg text-gray-900 dark:text-white mb-4">
              How to get the most from your 20 minutes
            </p>
            
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              20 minutes is your focus accelerator—enough to get absorbed in a task but short enough to avoid burnout. Ideal for editing a document or solving a problem, that need steady attention.
            </p>

            <ul className="space-y-4">
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Revise a draft or polish a presentation</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Fix a specific issue (e.g., coding bug, design tweak)</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Organize files or declutter a digital workspace</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Cook a simple meal or prep ingredients</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Recharge with a walk around the block or light yoga</span>
              </li>
            </ul>
          </div>
        </section>
