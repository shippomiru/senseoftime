...
function Timer15() {
  ...
  useEffect(() => {
    document.title = "15-Minute Timer | Start Tasks & Build Momentum";
    return () => {
        ...
        <section className="max-w-4xl mx-auto px-8 mb-40">
          ...
          <div className="space-y-6">
            ...
            <p className="font-bold text-lg text-gray-900 dark:text-white mb-4">
              How to get the most from your 15 minutes
            </p>
            
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              15 minutes is just right to get into the zone without burning out. Short bursts of full focus followed by breathers keep your brain fresh for the long haul. Nail one sprint at a time and watch progress stack.
            </p>

            <ul className="space-y-4">
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Launch into a task you've been delaying</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Sketch ideas or draft a rough plan</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Clear a small pile of emails or messages</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Tidy up a workspace or corner of a room</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Reset with a stretch or a quick mental reset</span>
              </li>
            </ul>
          </div>
        </section>
