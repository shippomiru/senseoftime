...
function Timer30() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Helmet>
        <title>30-Minute Timer | For Deep Work & Productivity</title>
        ...
        <section className="max-w-4xl mx-auto px-8 mb-40">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              30 minutes is your deep work zone—time to fully immerse in complex tasks without distractions. Perfect for strategic planning, creative projects, or powering through a critical to-do.
            </p>

            <ul className="space-y-4">
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Map out a project roadmap or brainstorm solutions</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Design a layout, write a chapter, or prototype an idea</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Batch-process bills, reports, or administrative work</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Deep-clean a room or reorganize a storage area</span>
              </li>
              <li className="flex items-start text-lg text-gray-600 dark:text-gray-300">
                <span className="mr-4 text-indigo-500">•</span>
                <span>Unwind with a guided meditation or mobility routine</span>
              </li>
            </ul>
          </div>
        </section>
